...
//
//  Created by Daniil Zadorozhnyy on 17.04.2022.
//
...
class EssentialFeedAPIEndToEndTests: XCTestCase {
    ...
    func test_endToEndTestServerGETFeedImageResult_matchesFixedTestAccountData() {
        ...
        case let .failure(error)?:
            XCTFail("Expected successful image data, got \(error) instead")
        default:
    ...
    func getFeedResult(file: StaticString = #file, line: UInt = #line) -> Swift.Result<[FeedImage], Error>? {
    ...
    private func getFeedImageDataResult(file: StaticString = #file, line: UInt = #line) -> FeedImageDataLoader.Result? {
        let testServerURL = testServerURL.appendingPathComponent("/73A7F70C-75DA-4C2E-B5A3-EED40DC53AA6/image")
